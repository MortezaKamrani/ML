...
def test_new_pic(imageName, num_px, classes, d):
    ## START CODE HERE ## (PUT YOUR IMAGE NAME) 
    my_image = imageName + ".jpg"   # change this to the name of your image file 
    ## END CODE HERE ##
...
def test():
    ...
    # Normal each row with normal function ==> x / ||x||
    ...
    # divide each example by the standard deviation of the whole numpy array. 
    # But for picture datasets, it is simpler and more convenient and works almost as well to just 
    ...
    # test_new_pic("mycat2", num_px, classes, d)
